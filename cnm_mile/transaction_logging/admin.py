...
class TouchnetTransactionAdmin(admin.ModelAdmin):
    ...
    list_display = ('date_created', 'user_id', 'first_name', 'last_name', 'title', 'amount', 'success_or_fail', 'details')
...
class InklingTransactionAdmin(admin.ModelAdmin):
    readonly_fields = fields = ['date_created', 'user_id', 'type', 'first_name', 'last_name', 'title', 'success_or_fail', 'details']
   # fields = ['user_id', 'title', 'success_or_fail', 'details']
    list_display = ('date_created', 'type', 'user_id', 'first_name', 'last_name', 'title', 'success_or_fail', 'details')
    search_fields = ['date_created', 'user_id', 'last_name']
